...
class customDropdown extends HTMLElement {
    constructor() {
        super();
        this.dropdownElement = this.querySelector('.size-variant_dropdown');
        this.dropdownElement.addEventListener('click', this.onButtonClick.bind(this));
        this.dropddownContainer = this.querySelector('.dropdownContainer');
    }
    onButtonClick(event) {
        event.preventDefault();
        if (this.dropddownContainer.classList.contains('active')) {
            this.dropddownContainer.classList.remove('active');
            this.classList.remove('open');
        } else {
            this.dropddownContainer.classList.add('active');
